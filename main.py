...
class ReadContent():
    def __init__(self,server, username, password, delimiter=',', table=None, recreate=False, database=None,dbms=None) -> None:
...
#     parser.add_argument('--dbms',choices=['postgres','mongo'],default='postgress')
...
#                     recreate=args.force, database=args.database, dbms=args.dbms)
